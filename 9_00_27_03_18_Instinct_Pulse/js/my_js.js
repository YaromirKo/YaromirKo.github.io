...
////////////////////////////////////////////////////////
				...
				//////////////////////////////////////////////////////////////chFoto
				var Change_profile_photo= $('.modal_prof_menu_icon1_Alert1_shadow1_Change-profile-photo');
				var show_Change_profile_photo = $('.modal_prof_menu_ch-foto');

				Change_profile_photo.on('click', function(event) {
					event.preventDefault();
					...
					show_Change_profile_photo.toggleClass('modal_prof_menu_ch-foto__active');
				});
////////////////////////////////////////////////////
				...
				ch_pass.on('click', function(event) {
					event.preventDefault();
					show_Edit_your_personal_info.removeClass('modal_prof_menu_edit-your-personal-infor__active');
					show_Change_profile_photo.removeClass('modal_prof_menu_ch-foto__active');
